...
async def process_all_questions(input_file: str, output_file: str, client: Any, model: str, concurrency: int = 3) -> None:
    ...
    async def sem_task(i, q):
        async with semaphore:
            return await process_question(i, q, total, client, model)
